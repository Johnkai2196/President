...
// construct the data source
        ...
        presidents.add(President("Sauno Koivisto", 1982, 1994, "Manu"))
...
/*        var orderPresident=presidents.sortedWith(compareBy { it.fullname })
        for (obj in orderPresident) {
            Log.d("USR",(obj.toString()))
        }*/
    }
}
